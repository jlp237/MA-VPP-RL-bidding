...
def prepare_activation(self):
    ...
    logging.debug("log_step: " + str(self.logging_step) + " slot: " + "None" + " self.delivery_results['bid_sizes_all_slots'] : " + str(self.delivery_results['bid_sizes_all_slots']))
...
def simulate_activation(self, slot):
    ...
    self.delivery_results["positive_activation_possible_list"][slot] = positive_activation_possible_list
    self.delivery_results["negative_activation_possible_list"][slot] = negative_activation_possible_list
