...
def simulate_market(self, action_dict):
    ...
    for slot in range(0, len(self.slot_date_list)):
        ...
        #logging.debug("log_step: " + str(self.logging_step) + " slot: " +  str(slot)   + " slot_bids = " + str(slot_bids))
        slot_bids_list = slot_bids.to_dict('records')
        #logging.debug("log_step: " + str(self.logging_step) + " slot: " +  str(slot)   + " slot_bids_list = " + str(slot_bids_list))
