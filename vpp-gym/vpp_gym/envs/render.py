    ...
    if not self.activation_results:
        ...
        if self.env_type != "test":
            ...
            if self.logging_step > 0: 
                ...
                reserved_data = {'Reserved': slots_reserved, 'NOT Reserv.': slots_not_reserved, 'Slot lost.': slots_not_participated}
                ...
                reserved_plot = px.bar(reserved_df,  x=reserved_df.index, y=['Reserved', 'NOT Reserv.', 'Slot lost.'], color_discrete_sequence=[ "#239B56", "#B03A2E", "gainsboro"] , labels={"index": "Slot"}, title="Reservation per Slot")
                ...
                delivered_data = {'Delivered': slots_delivered, 'NOT Deliv.': slots_not_delivered, 'Slot not res.': slots_not_participated}
                ...
                delivered_plot = px.bar(delivered_df,  x= delivered_df.index, y=['Delivered', 'NOT Deliv.', 'Slot not res.'], color_discrete_sequence=[ "#2ECC71", "#E74C3C", "gainsboro"] , labels={"index": "Slot"}, title="Activation per Slot")
